export default function Navbar () {
  ...
  return(
    <nav className="fixed left-0 w-52 h-full bg-zinc-900">
      <div className="flex flex-col justify-start items-center w-full pt-10 pb-6 bg-black">
        <div className="flex flex-row justify-center items-center gap-2 w-full">
          <span className="text-8xl font-semibold">g</span>
          <div id="console" className="w-10 h-28 bg-neutral-200"></div>
        </div>
      ...
      <ul className="mt-6 text-center text-neutral-400 text-lg font-light border-t-[1px] border-neutral-400/60 *:py-3 *:border-b-[1px] *:border-neutral-400/60">
